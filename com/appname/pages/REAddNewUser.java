...
public class REAddNewUser {
	...
	public boolean AdminLogin(String un,String pw)
	{
		       ...
		       ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
				...
				driver.findElement(Username).sendKeys("wh78772");
				driver.findElement(Email).sendKeys("gjbnj@gmail.com");
				driver.findElement(FirstName).sendKeys("jlgjhkn");
				driver.findElement(LastName).sendKeys("mbmbhja");
				driver.findElement(Website).sendKeys("CREDDD");
				driver.findElement(ShowPassword).click();
				driver.findElement(Cancel).click();
				driver.findElement(ShowPassword).click();
				driver.findElement(PasswordInput).sendKeys("Hiykhg@543");
